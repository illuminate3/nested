...
<div class="row">
{{ Form::model($assetStatus, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('assetStatuses.update', $assetStatus->id))) }}

{{-- Form::open(
	[
		'route' => array('assetStatuses.update', $assetStatus->id),
		'assetStatus' => 'form',
		'method' => 'PATCH'
	]
) --}}
