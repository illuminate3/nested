...
class AssetStatusesController extends BaseController {
	...
	public function store()
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('assetStatuses.index');
		}

		return Redirect::route('assetStatuses.create')
			->withInput()
	...
	public function update($id)
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('assetStatuses.show', $id);
		}

		return Redirect::route('assetStatuses.edit', $id)
			->withInput()
			->withErrors($validation)
			->with('message', 'There were validation errors.');
	}
